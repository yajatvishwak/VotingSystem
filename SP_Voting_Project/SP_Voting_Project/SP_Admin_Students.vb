...
Public Class SP_Admin_Students
    ...
    Private Sub LoadData()
        table.Clear()
        con1.Open()
        cmd.CommandText = "SELECT [id] , [class] , [section] , [roll_no] , [student_name] , [house_color] , [login_id] , [password] , [gender] from SP_Student_Master"
        cmd.ExecuteNonQuery()
        con1.Close()
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ClassCombo.SelectedIndexChanged
        Login_idTextBox.Text = ClassCombo.SelectedItem + SectionCombo.SelectedItem + Roll_noTextBox.Text
    End Sub
    ...
    Private Sub DataGridView1_MouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles DataGridView1.MouseClick
        Try
            ...
            If DataGridView1.SelectedCells.Count > 0 Then
                ...
                PasswordTextBox.Text = DataGridView1.SelectedCells(7).Value
                GenderCmbo.Text = DataGridView1.SelectedCells(8).Value
            End If
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub House_colorLabel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    End Sub
    Private Sub HouseCombo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles HouseCombo.SelectedIndexChanged

    End Sub
    Private Sub GenderCmbo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GenderCmbo.SelectedIndexChanged
